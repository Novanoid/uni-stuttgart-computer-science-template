...
% Set up the listings package for nice code highlighting
\usepackage{listings}
...
\lstset{
  ...
  commentstyle=\color[rgb]{0.13,0.29,0.53}\itshape,
...
%%%
% Schriften
\input{markdown/template/include/preambel/fonts}
%
%%%
...
\usepackage[
      ...
      startdate={$meta.start-date$},
      enddate={$meta.end-date$},
      crk={$meta.crk$}
...
%%%
% Rand
\input{markdown/template/include/preambel/margins}
%
%%%
